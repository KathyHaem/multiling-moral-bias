...
from mort.funcs_mcm import get_sen_embedding_from, BERTSentenceSubspace, BERTSentence, PytorchPCATransform
    ...
    if adapted:
        ...
        if subspace:
            ...
            model_mcm = BERTSentenceSubspace(device=device,
                                             transformer_model=transormer_model,
            ...
            model_mcm = BERTSentence(transformer_model=transormer_model)
